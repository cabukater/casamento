...
(function() {
  ...
  function accountKit($q, $http, $cordovaOauthUtility) {
    ...
    function oauthaccountkit(url_app, uri) {
      ...
      if(window.cordova) {
        if($cordovaOauthUtility.isInAppBrowserInstalled()) {
          var redirect_uri = window.location.host;
          /*if(typeof uri !== "undefined") {
                redirect_uri = uri;
          }*/
          var api_id = '531228893597329';
          /*var browserRef = window.cordova.InAppBrowser.open('https://www.accountkit.com/v1.0/dialog/sms_login/?app_id='+api_id+'&country_code=%2B55&fb_app_events_enabled=true&locale=pt_BR&logging_ref=f2b531fda08f9f4&redirect='+redirect_uri+'&origin=' + url_app + '&sdk=web&state=abcd', '_self', 'location=no,clearsessioncache=yes,clearcache=yes');*/
          /*var browserRef = window.cordova.InAppBrowser.open('https://apptest2.superagendador.com/autentica_pfv.php/?url='+url_app, '_self', 'location=no,clearsessioncache=yes,clearcache=yes');*/
          var browserRef = window.cordova.InAppBrowser.open('https://app.superagendador.com/unira03', '_system', 'location=no,clearsessioncache=yes,clearcache=yes,hardwareback=no');
          browserRef.addEventListener('loadstop', function(event) {
            ...
            var loop = setInterval(function() {
                ...
                browserRef.executeScript({
                    code: "localStorage.getItem('password');alert(1+1);"
                  },
                  function(values) {
...
(function() {
  ...
  function cordovaOauth(
    ...
    $ngCordovaDribble, $ngCordovaPocket, $ngCordovaMercadolibre, $ngCordovaXing, $ngCordovaNetatmo, $ngCordovaTraktTv, $ngCordovaYahoo, $ngCordovaAccountKit) {
    ...
    return {
      ...
      accountkit: $ngCordovaAccountKit.signin
    };
  }
